...
public class TransactionServiceTest {
    ...
    void findAll() {
        final var transactions = List.of(
                new Transaction("{ \"reference\": \"foo_reference_1\", \"amount\": 300}"),
                new Transaction("{ \"reference\": \"foo_reference_2\", \"amount\": 100}"));
    ...
    void createTransaction() {
        final var jsonData = "{ \"reference\": \"foo_reference_2\", \"amount\": 100}";
    ...
    void updateTransactionSuccess() {
        final var id = 1L;
        final var updateData = "{ \"reference\": \"foo\", \"amount\": 100}";
        ...
        when(repository.save(any(Transaction.class))).thenReturn(new Transaction(updateData));
